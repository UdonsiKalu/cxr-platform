...
| URL | Purpose |
|-----|---------|
| http://127.0.0.1:3001/d/cxr-hpa-load-003 | **Grafana** — replicas, Pending (refresh 5s) |
...
| Signal | Tool |
|--------|------|
| RPS, p50, p95 | **Locust** :8092 Charts |
| Replicas, Pending | **Grafana** (kube-state-metrics) |
| Per-request latency | **Jaeger** |
| All-in-one post-run chart | **CSV + plot_load_test.py** |
